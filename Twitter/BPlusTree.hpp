...
private:
    bool get(Node* node, int key, int& value);
    void insertNode(Node* node, int key, int value, Node* p, stack<Node *>* parent);
...
public:
    ...
    map<int, int> getrange(int key1, int key2);
};
